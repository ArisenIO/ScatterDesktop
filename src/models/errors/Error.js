...
export default class Error {
    ...
    static signatureAccountMissing(){
        return this.signatureError("account_missing", "You are trying to sign a request with an account that isn't currently linked or doesn't exist in the user's ArisenID");
    }
