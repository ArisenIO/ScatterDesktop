    ...
    <section>
        ...
        <section class="panel">
            ...
            <section class="selected-item scrollable">
                ...
                <figure class="description">Read through the terms below fully so that you understand how both ArisenID and you are protected.</figure>
                    ...
                    <section class="info-box">
                        ...
                        <figure class="terms">
                            ...
                            <b>
                                ...
                                rules and conditions of participation issued by ArisenID from time to time. If you do not agree to the Terms, then you may not access or use the Content or Services.
                            </b>
                            ...
                            ArisenID reserves the right, at its sole discretion, to modify or replace the Terms of Use at any time.
                            The most current version of these Terms will be posted on https://arkid.io (the "Site"). You shall be responsible for
                            ...
                            <br><br>
                            ArisenID is a global platform and by accessing the Site or Services, you are representing and warranting that, you are of the legal age of majority in your jurisdiction as is required
                            ...
                            with the laws of your jurisdiction and acknowledge that ArisenID is not liable for your compliance with such laws.
                            ...
                            By using ArisenID you recognize yourself as the sole legal owner of your own secrets, keys, passwords, seed phrases, and other private data.
                            ...
                            <br><br>
                            <br><br>
                            <h1>5. REPRESENTATIONS, WARRANTIES AND RISKS</h1>

                            <h2>5.1. Warranty disclaimer</h2>
                            ...
                            particular purpose or non-infringement. You acknowledge that ArisenID has no control over, and no duty to take any action regarding: which users gain access to or use the
                            ...
                            You release ArisenID from all liability for you having acquired or not acquired Content through the Service. ArisenID makes no representations concerning any Content contained
                            in or accessed through the Service, and ArisenID will not be responsible or liable for the accuracy, copyright compliance, legality or decency of material contained in or accessed
                            through the Service.
                            <br><br>
                            <h2>5.2 Sophistication and Risk of Cryptographic Systems</h2>

                            By utilizing the Service or interacting with the Content or platform in any way, you represent that you understand the inherent risks associated with cryptographic systems;
                            and warrant that you have an understanding of the usage and intricacies of native cryptographic tokens, smart contract based tokens that
                            follow various Tokens standards, and blockchain-based software systems.
                            <br><br>
                            <h2>5.3 Risk of Regulatory Actions in One or More Jurisdictions</h2>

                            ArisenID and the supported blockchains and tokens could be impacted by one or more regulatory inquiries or regulatory action, which could impede or limit the ability of ArisenID to continue to develop,
                            ...
                            To the extent possible, ArisenID intends to update the protocols underlying the Service to account for any advances in cryptography and to incorporate additional security measures, but does not guarantee or
                            ...
                            activities taking place on the supported blockchains. You acknowledge these risks and represent that ArisenID cannot be held liable for such fluctuations in both time and costs.
                            <br><br>
                            ...
                            and represent that blockchain applications can be written maliciously or negligently, that ArisenID cannot be held liable for your interaction with such applications and that
                            such applications may cause the loss of property or even identity. This warning and others later provided by ArisenID in no way evidence or represent an on-going duty to alert
                            ...
                            You agree to release and to indemnify, defend and hold harmless ArisenID and its parents, subsidiaries, affiliates and agencies, as well as the officers, directors, employees,
                            ...
                            defamation or invasion of privacy. ArisenID reserves the right, at its own expense, to assume exclusive defense and control of any matter otherwise subject to indemnification by you and, in such case,
                            you agree to cooperate with ArisenID in the defense of such matter.
                            ...
                            SITE AND SERVICE IS AT YOUR OWN RISK. RECOGNIZING SUCH, YOU UNDERSTAND AND AGREE THAT, TO THE FULLEST EXTENT PERMITTED BY APPLICABLE LAW, NEITHER ARISENID NOR ITS SUPPLIERS OR
                            ...
                            (EVEN IF ARISENID HAD BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES), RESULTING FROM THE SITE OR SERVICE; THE USE OR THE INABILITY TO USE THE SITE OR SERVICE; UNAUTHORIZED
                            ...
                            EQUIPMENT; INABILITY TO FULLY ACCESS THE SITE OR SERVICE OR ANY OTHER WEBSITE; THEFT, TAMPERING, DESTRUCTION, OR UNAUTHORIZED ACCESS TO, IMAGES OR OTHER CONTENT OF ANY KIND;
                            DATA THAT IS PROCESSED LATE OR INCORRECTLY OR IS INCOMPLETE OR LOST; TYPOGRAPHICAL, PRINTING OR OTHER ERRORS, OR ANY COMBINATION THEREOF; OR ANY OTHER MATTER RELATING TO THE
                            SITE OR SERVICE.
                            <br><br>
                            ...
                            All title, ownership and intellectual property rights in and to the Service are owned by ArisenID or its licensors. You acknowledge and agree that the Service contains
                            proprietary and confidential information that is protected by applicable intellectual property and other laws. Except as expressly authorized by ArisenID, you agree not to copy,
                            modify, rent, lease, loan, sell, distribute, perform, display or create derivative works based on the Service, in whole or in part. ArisenID issues licenses for ArisenID's various code-bases,
                            which can be found on their individual repositories. Each code-base might have a different license. You can find all official repositories at https://github.com/arisenio.
                            ...
                            The Service provides, or third parties may provide, links to other accessible internet websites, applications or resources. Because ArisenID might have no control over such sites,
                            applications and resources, you acknowledge and agree that ArisenID is not responsible for the availability of such external sites, applications or resources, and does not endorse and is not
                            responsible or liable for any content, advertising, products or other materials on or available from such sites or resources. You further acknowledge and agree that ArisenID shall not be responsible
                            ...
                            ArisenID may terminate or suspend all or part of the Service and your ArisenID access immediately, without prior notice or liability, if you breach any of the terms or conditions of the Terms.
                            ...
                            <br><br>
                            <br><br>
                            <h1>11. No third party beneficiaries</h1>
                            ...
                            If you believe that your copyright or the copyright of a person on whose behalf you are authorized to act has been infringed, please provide ArisenID's Copyright Agent a
                            ...
                            <br><br>
                            For copyright issues, please reach out to the elected Arisen Governance:<br>
                            Email: copyright [at] arisengov [dot] io


                            <br><br>
                            <br><br>
                            <h1>13. Binding arbitration and class action waiver</h1>

                            PLEASE READ THIS SECTION CAREFULLY – IT MAY SIGNIFICANTLY AFFECT YOUR LEGAL RIGHTS, INCLUDING YOUR RIGHT TO FILE A LAWSUIT IN COURT

                            <h2>13.1 Initial Dispute Resolution</h2>

                            The parties shall use their best efforts to engage directly to settle any dispute, claim, question, or disagreement and engage in good faith negotiations which shall be a
                            condition to either party initiating a lawsuit or arbitration.

                            <br><br>
                            <h2>13.2 Binding Arbitration</h2>

                            If the parties do not reach an agreed upon solution within a period of 30 days from the time informal dispute resolution under the Initial Dispute Resolution provision begins,
                            then either party may initiate binding arbitration as the sole means to resolve claims, subject to the terms set forth below. Specifically, all claims arising out of or relating
                            to these Terms (including their formation, performance and breach), the parties’ relationship with each other and/or your use of the Service shall be finally settled by binding
                            arbitration administered by the American Arbitration Association in accordance with the provisions of its Commercial Arbitration Rules and the supplementary procedures for consumer
                            related disputes of the American Arbitration Association (the “AAA”), excluding any rules or procedures governing or permitting class actions.
                            <br><br>
                            ...
                            applicability, enforceability or formation of these Terms, including, but not limited to any claim that all or any part of these Terms are void or voidable, or whether a claim
                            is subject to arbitration. The arbitrator shall be empowered to grant whatever relief would be available in a court under law or in equity. The arbitrator’s award shall be written,
                            and binding on the parties and may be entered as a judgment in any court of competent jurisdiction.
                            <br><br>
                            The parties understand that, absent this mandatory provision, they would have the right to sue in court and have a jury trial. They further understand that,
                            ...
                            Binding arbitration shall take place in New York. You agree to submit to the personal jurisdiction of any federal or state court in New York County, New York,
                            ...
                            and the parties expressly waive their right to file a class action or seek relief on a class basis. YOU AND ARKID AGREE THAT EACH MAY BRING CLAIMS AGAINST THE OTHER
                            ...
                            <br><br>
                            <h2>13.5 Exception - Litigation of Intellectual Property and Small Claims Court Claims</h2>

                            Notwithstanding the parties’ decision to resolve all disputes through arbitration, either party may bring an action in state or federal court to protect its intellectual
                            property rights (“intellectual property rights” means patents, copyrights, moral rights, trademarks, and trade secrets, but not privacy or publicity rights). Either party may
                            ...
                            to the following email address: legal [at] arisegov [dot] io. The notice must be sent within 30 days of
                            ...
                            If you opt-out of these arbitration provisions, ArisenID also will not be bound by them.

                            <br><br>
                            <h2>13.7 Changes to this Section</h2>

                            ArisenID will provide 60-days’ notice of any changes to this section. Changes will become effective on the 60th day, and will apply prospectively only to any claims
                            arising after the 60th day.
                            <br><br>
                            For any dispute not subject to arbitration you and ArisenID agree to submit to the personal and exclusive jurisdiction of and venue in the federal and state courts located
                            ...
                            <br><br>
                            The Terms and the relationship between you and ArisenID shall be governed by the laws of the State of New York without regard to conflict of law provisions.
                            ...
                            <br><br>
                            <br><br>
                            <h1>14. GENERAL INFORMATION</h1>

                            <h2></h2>

                            These Terms (and any additional terms, rules and conditions of participation that ArisenID may post on the Service) constitute the entire agreement between you and
                            ArisenID with respect to the Service and supersedes any prior agreements, oral or written, between you and ArisenID. In the event of a conflict between these Terms and
                            ...
                            The failure of ArisenID to exercise or enforce any right or provision of the Terms shall not constitute a waiver of such right or provision. If any provision of the Terms
                            ...
                            <br><br>
                            <h2>14.3 Statute of Limitations</h2>

                            You agree that regardless of any statute or law to the contrary, any claim or cause of action arising out of or related to the use of the Service or the Terms must be
                            filed within one (1) year after such claim or cause of action arose or be forever barred.

                            <br><br>
                            <h2>14.4 Section Titles</h2>

                            The section titles in the Terms are for convenience only and have no legal or contractual effect.

                            <br><br>
                            <h2>14.5 Communications</h2>
    ...
    export default {
        ...
        methods: {
            async acceptTerms(accepted){
                if(!accepted){
                    await StorageService.removeArisenID();
                    this.$router.push('/')
                    return false;
                }
